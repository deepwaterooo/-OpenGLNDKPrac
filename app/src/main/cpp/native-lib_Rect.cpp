...
extern "C" {
    JNIEXPORT jboolean JNICALL Java_com_me_opengl_RectLib_initR(JNIEnv *env, jclass type);
    JNIEXPORT void JNICALL Java_com_me_opengl_RectLib_resizeR(JNIEnv *env, jclass type, jint width, jint height);
    JNIEXPORT void JNICALL Java_com_me_opengl_RectLib_stepR(JNIEnv *env, jclass type);
    JNIEXPORT void JNICALL Java_com_me_opengl_RectLib_destroyR(JNIEnv *env, jclass type);
};

jboolean
Java_com_me_opengl_RectLib_initR(JNIEnv *env, jclass type) {
    if (g_renderer) {
        delete g_renderer;
        g_renderer = NULL;
    }
...
void
Java_com_me_opengl_RectLib_resizeR(JNIEnv *env, jclass type, jint width, jint height) {
    if (g_renderer) {
        g_renderer->resize(width, height);
    }
}
void
Java_com_me_opengl_RectLib_stepR(JNIEnv *env, jclass type) {
    if (g_renderer) {
        g_renderer->render();
    }
}
void
Java_com_me_opengl_RectLib_destroyR(JNIEnv *env, jclass type) {
    delete g_renderer;
    g_renderer = NULL;
}
#undef LOG_TAG
